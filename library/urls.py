...
from library.views import AuthorViewSet, BookListAPIView, BookCreateAPIView, BookRetrieveAPIView, BookUpdateAPIView, \
    BookDestroyAPIView, IssuanceBookCreateAPIView, IssuanceBookListAPIView, StatisticIssuanceBookListAPIView
...
urlpatterns = [
    ...
    path("issuance_list/", IssuanceBookListAPIView.as_view(), name="issuance_book_list"),
